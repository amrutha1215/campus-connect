      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">BVRIT Hyderabad </h2>
              <p>The Department of CSE at BVRIT Hyderabad provides high-quality education in Computer Science & Engineering, fostering research and equipping students for industry success.</p>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text"> BVRIT Hyderabad College of Engineering for Women,
                        Nizampet, Bachupally,
                        Hyderabad - 500 090,
                        Telangana, India. </span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+91 40 4241 7773</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">support@bvrithyderabad.edu.in</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p>
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | BVRIT Hyderabad
   </p>
          </div>
        </div>
      </div>
